class Page < ApplicationRecord
    ...
    belongs_to :versionable, polymorphic: true, optional: true
    belongs_to :author, class_name: 'User', inverse_of: :pages, optional: true
	...
	def full_url
		[Rails.application.credentials.domain, slug].join("/")
	end
