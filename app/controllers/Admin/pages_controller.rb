class Admin::PagesController < ApplicationController
  ...
  private
    ...
    def page_params
      ...
      # blocks_attributes: [:id, :number, :content, :category, :image_id],
      # asset_attributes: [:id, :title, :alt, :number, :img, :video, :audio, :asset_type, :mime_type, :extension, :width, :height, :slug, :size, :assetable_type, :assetable_id]
    end
