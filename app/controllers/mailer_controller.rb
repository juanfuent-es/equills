class MailerController < ApplicationController
  ...
  def mail
    ...
    @link_color = "#55859a";
    @font = "color:#000;#{@fontfamily}font-size:16px;font-style:normal;font-weight:400;line-height:20px;letter-spacing:normal;margin:0;padding:0;text-align:center;"
